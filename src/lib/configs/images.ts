...
const images: Images = {
  ...
  findImageIcon(name: string): string | null {
    ...
    return this.icons.find(icon => icon.name === name)?.image || null;
  }
};

// Initialize icons array
images.icons = [
  { name: "back", image: images.device.backIcon },
  { name: "print", image: images.device.printIcon },
  { name: "continue", image: images.device.rightIcon },
  { name: "cancel", image: images.cancelIcon },
  { name: "send", image: images.device.sendIcon },
  { name: "login", image: images.device.signIcon },
  { name: "save", image: images.saveIcon },
  { name: "edit", image: images.edit },
  { name: "delete", image: images.deleteIcon },
  { name: "add", image: images.addField },
  { name: "play", image: images.device.playIcon },
  { name: "pause", image: images.device.pauseIcon },
  { name: "skip-to-begin", image: images.device.skipToBegin },
  { name: "skip-to-end", image: images.device.skipToEnd },
  { name: "ff", image: images.device.ffIcon },
  { name: "rw", image: images.device.rwIcon },
  { name: "disconnect", image: images.device.disconnectIcon },
  { name: "right", image: images.device.rightIcon },
  { name: "left", image: images.device.leftIcon },
  { name: "up", image: images.device.upIcon },
  { name: "down", image: images.device.downIcon },
  { name: "reset", image: images.device.resetIcon },
  { name: "settings", image: images.device.settingsIcon },
  { name: "radio/checked", image: images.device.radio.checked },
  { name: "radio/unchecked", image: images.device.radio.unchecked },
  { name: "checkbox/checked", image: images.device.checkbox.checked },
  { name: "checkbox/unchecked", image: images.device.checkbox.unchecked },
  { name: "qrcode", image: images.qrcode },
  { name: "encrypt", image: images.device.encrypt },
  { name: "decrypt", image: images.decryptIcon },
  { name: "home", image: images.device.home },
  { name: "export", image: images.exportIcon },
  { name: "import", image: images.importIcon }
];
