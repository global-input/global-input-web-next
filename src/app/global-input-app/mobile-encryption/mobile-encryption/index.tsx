...
export default function MobileEncryption({ domain, back }: MobileEncryptionProps) {
        ...
        case PAGES.CONTENT_ON_COMPUTER:
            return (
                <ContentOnComputer 
                    ...
                    cancel={back} 
                    contentOnMobile={contentOnMobile} 
        ...
        case PAGES.START_ENCRYPT:
            return (
                <EncryptContent 
                    domain={domain} 
                    content={content} 
                    showOnComputer={showOnComputer} 
                    contentOnComputer={contentOnComputer} 
                />
            )
        case PAGES.SHOW_ON_COMPUTER:
            return (
                <ShowResultOnComputer 
                    domain={domain} 
                    content={content} 
                    contentOnComputer={contentOnComputer} 
                    finish={back} 
