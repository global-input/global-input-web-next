...
function MobileEncryptionPageContent() {
...
// Option 1: Using an inline styled div for padding
export default function MobileEncryptionPage() {
  return (
    <ApplicationTopContainer>      
        <MobileEncryptionPageContent />      
    </ApplicationTopContainer>
  )
}
