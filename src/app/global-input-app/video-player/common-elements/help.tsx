...
const ExpandIcon = styled.div<ExpandProps>`
...
const HelpContainer = ({ position = 1, children }: { position?: number, children: React.ReactNode }) => {
    if (position === 2) {
...
const HelpContent = styled.div<ExpandProps>`
    font-family: Avenir;
...
export const Help: React.FC<HelpProps> = ({ children, expandId, expand, setExpand, position = 1 }) => {
